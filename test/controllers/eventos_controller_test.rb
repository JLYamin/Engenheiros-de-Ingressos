...
class EventosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create evento" do
    assert_difference('Evento.count') do
      post eventos_url, params: { evento: { date_begin: @evento.date_begin, date_end: @evento.date_end, tickets_total: @evento.tickets_total, title: @evento.title } }
    end
  ...
  test "should update evento" do
    patch evento_url(@evento), params: { evento: { date_begin: @evento.date_begin, date_end: @evento.date_end, tickets_total: @evento.tickets_total, title: @evento.title } }
