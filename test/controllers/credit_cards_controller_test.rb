...
class CreditCardsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create credit_card" do
    assert_difference('CreditCard.count') do
      post credit_cards_url, params: { credit_card: { expiration: @credit_card.expiration, number: @credit_card.number, security: @credit_card.security } }
    end
  ...
  test "should update credit_card" do
    patch credit_card_url(@credit_card), params: { credit_card: { expiration: @credit_card.expiration, number: @credit_card.number, security: @credit_card.security } }
